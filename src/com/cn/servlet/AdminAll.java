...
public class AdminAll extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(count>=(page-1)){
		 ...
		 out.println("<tr>");
		 out.println("<td colspan='6'><button type='submit' class='btn btn-default' id='add'>新增员工</button><button type='submit' class='btn btn-default' id='delete'>删除员工</button></td>");
		 out.println("<tr>");
		 out.println("</table>");
		}
		out.flush();
