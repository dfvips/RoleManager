  	...
  	<div class="container" id="alter">
		 ...
		 <table class="table">
		    <tbody>
		      <tr>
		        <td>用&nbsp;户&nbsp;名:</td>
		        <td><input type="text" id="update_name"/></td>
		      </tr>
		      <tr>
		        <td>性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别:</td>
		        <td><input type="text" id="update_gender"/></td>
		      </tr>
		      <tr>
		        <td>手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机:</td>
		        <td><input type="number" id="update_phone" value=""/></td>
		      </tr>
		      <tr>
		        <td>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱:</td>
		        <td><input type="email" id="update_email" value="" /></td>
		      </tr>
		      <tr>
		        <td>地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址:</td>
		        <td><input type="text" id="update_address" value="" /></td>
		      </tr>
		      <tr>
		        <td>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:</td>
		        <td><input type="password" id="update_password" /></td>
		      </tr>
		      <tr>
		        <td>确认密码:</td>
		        <td><input type="password" id="update_repassword"/></td>
		      </tr>
		      <tr>
		        <td colspan="2"><div id="td_bottom"><button type="button" class="btn btn-default" id="btn_update">确定</button><button type="button" class="btn btn-default" id="btn_cancle">取消</button></div></td>
		      </tr>
		    </tbody>
		 </table>
	</div>
  	<div class="container" id="panel_delete">
  		<h2>删除员工</h2>      
  		<div id="page1"></div>
	</div>
