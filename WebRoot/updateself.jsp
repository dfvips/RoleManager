...
<html>
  ...
  <table class="table">
    <tbody>
      ...
      <tr>
        <td>手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机:</td>
        <td><input type="text" id="phone" value="${sessionScope.phone}"/></td>
      </tr>
      <tr>
        <td>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱:</td>
        <td><input type="email" id="email" value="${sessionScope.email}" /></td>
      </tr>
      <tr>
        <td>地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址:</td>
        <td><input type="text" id="address" value="${sessionScope.address}" required/></td>
      </tr>
      <tr>
        <td>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:</td>
      ...
      <tr>
        <td colspan="2"><button type="button" class="btn btn-default" id="update">修改</button><button type="button" class="btn btn-default" id="cancle">取消</button></td>
      </tr>
    </tbody>
  </table>
</div>
<div id="footer"><p>Copyright © 2019 DreamFly.All Rights Reserved.</p><p>梦丶随心飞&nbsp;&nbsp;版权所有</p></div>
	<script src="js/updateself.js"></script>
  </body>
</html>
